  ...
  return (
    <header className="bg-header bg-cover h-[400px] md:h-[calc(100vh-228px)]">
        ...
        <section className='w-full bg-white'>
            <section className='text-black text-3xl font-semibold container mx-auto flex gap-4 md:gap-8 lg:gap-12 p-4 md:p-8'>
                <section className='animated flex items-center gap-2 md:gap-4'>
                    ...
                    <p className='text-base md:text-2xl lg:text-3xl'>Cabana Aleu</p>
                </section>
                <section className='animated flex items-center gap-2 md:gap-4'>
                    ...
                    <p className='text-base md:text-2xl lg:text-3xl'>O săptămana</p>
                </section>
                <section className='animated flex items-center gap-2 md:gap-4'>
                    ...
                    <p className='text-base md:text-2xl lg:text-3xl'>1900 RON</p>
                </section>
            </section>
        </section>
    </header>
